  ...
  return <div className="farmDetail">
    ...
    <section className={`farmHero ${compactHero?'compactHero':''}`}>
      <div>
        ...
        {!compactHero&&<div className="farmHeroMeta"><span><MapPin size={16}/>{farm.cidade||'Cidade não informada'}</span><span><Building2 size={16}/>{centralOfficialName(farm.central)||'Central não informada'}</span><span><User size={16}/>{farm.regional_nome||farm.responsavel||'Regional não informado'}</span></div>}
